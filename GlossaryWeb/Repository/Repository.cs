...
namespace GlossaryWeb.Repository
{
    ...
    public async Task<bool> Create(string url, T objToCreate, string token = "")
    {
    ...
    public async Task<IEnumerable<T>> GetAll(string url, string token = "")
    {
    ...
    public async Task<T> Get(string url, int Id, string token = "")
    {
    ...
    public async Task<bool> Update(string url, T objToUpdate, string token = "")
    {
